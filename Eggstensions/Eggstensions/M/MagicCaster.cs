namespace Eggstensions
{
	...
	unsafe public struct MagicCaster
	{
		...
		static public void Cast(MagicCaster* magicCaster, SpellItem* spell, System.Boolean noHitEffectArt, Actor* target, System.Single dualCastingMultiplier, System.Boolean hostileDualCastingMultiplierOnly, System.Single magnitudeOverride, Actor* cause)
		{
			var cast = Memory.ReadVirtualFunction<Eggstensions.Delegates.Types.MagicCaster.Cast>(*(System.IntPtr*)magicCaster, 0x1);

			cast(magicCaster, spell, (System.Byte)(noHitEffectArt ? 1 : 0), target, dualCastingMultiplier, (System.Byte)(hostileDualCastingMultiplierOnly ? 1 : 0), magnitudeOverride, cause);
		}
	}
}
