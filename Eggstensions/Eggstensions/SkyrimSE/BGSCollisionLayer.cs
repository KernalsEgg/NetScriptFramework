namespace Eggstensions.SkyrimSE
{
	...
	{
		public enum CollisionLayerTypes : System.UInt32
		{
			Unidentified =			0x0u,
			Static =				0x1u,
			AnimStatic =			0x2u,
		...
		static public System.IntPtr CollisionFilter
		{
			get
			{
				...
				if (collisionFilter == System.IntPtr.Zero) { throw new Eggceptions.NullException(nameof(collisionFilter)); }
		...
		{
			if (collisionLayer == System.IntPtr.Zero) { throw new Eggceptions.ArgumentNullException(nameof(collisionLayer)); }

			return collisionLayer + 0x48;
		}
		
		/// <param name="collisionLayer">BGSCollisionLayer</param>
		static public BGSCollisionLayer.CollisionLayerTypes GetCollisionLayerType(System.IntPtr collisionLayer)
		{
			if (collisionLayer == System.IntPtr.Zero) { throw new Eggceptions.ArgumentNullException(nameof(collisionLayer)); }

			return (BGSCollisionLayer.CollisionLayerTypes)(NetScriptFramework.Memory.ReadUInt32(collisionLayer + 0x30) & 0x7F);
		}
