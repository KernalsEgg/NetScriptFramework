	...
	static public class SceneGraph
	{
		...
		static public System.IntPtr Menu3DRootNode
		{
			get
			{
				...
				if (menu3DRootNode == System.IntPtr.Zero) { throw new Eggceptions.NullException("menu3DRootNode"); }
		...
		static public System.IntPtr MenuRootNode
		{
			get
			{
				...
				if (menuRootNode == System.IntPtr.Zero) { throw new Eggceptions.NullException("menuRootNode"); }
		...
		static public System.IntPtr WorldRootNode
		{
			get
			{
				...
				if (worldRootNode == System.IntPtr.Zero) { throw new Eggceptions.NullException("worldRootNode"); }
		...
		{
			if (sceneGraph == System.IntPtr.Zero) { throw new Eggceptions.ArgumentNullException("sceneGraph"); }

			var camera = NetScriptFramework.Memory.ReadPointer(sceneGraph + 0x128);
			if (camera == System.IntPtr.Zero) { throw new Eggceptions.NullException("camera"); }
